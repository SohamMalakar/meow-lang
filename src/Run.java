...
public class Run
{
    ...
    static
    {
        ...
        symbolTable.set("fopen", new _BuiltInFunction("fopen"));
        symbolTable.set("fread", new _BuiltInFunction("fread"));
        symbolTable.set("freadline", new _BuiltInFunction("freadline"));
        symbolTable.set("freadlines", new _BuiltInFunction("freadlines"));
        symbolTable.set("fwrite", new _BuiltInFunction("fwrite"));
        symbolTable.set("fwritelines", new _BuiltInFunction("fwritelines"));
        symbolTable.set("fseek", new _BuiltInFunction("fseek"));
        symbolTable.set("ftell", new _BuiltInFunction("ftell"));
        symbolTable.set("flen", new _BuiltInFunction("flen"));
        symbolTable.set("frewind", new _BuiltInFunction("frewind"));
        symbolTable.set("feof", new _BuiltInFunction("feof"));
        symbolTable.set("freadable", new _BuiltInFunction("freadable"));
        symbolTable.set("fwritable", new _BuiltInFunction("fwritable"));
        symbolTable.set("fflush", new _BuiltInFunction("fflush"));
        symbolTable.set("fclose", new _BuiltInFunction("fclose"));
        symbolTable.set("fclosed", new _BuiltInFunction("fclosed"));
